...
/**
 * Boundary conditions for {@link AmericanOption} under the {@link FDMBachelierModel}.
 *
 * <p>
 ...
 *
 * <p>
 * The implementation mirrors the structure used for Black–Scholes boundaries
 * (same control flow and time safety) :contentReference[oaicite:2]{index=2}, but with linear
 * asymptotics (normal model) instead of lognormal ones.
 * </p>
 *
 * @author Alessandro Gnoatto
 */
public class AmericanOptionBachelierModelBoundary implements FiniteDifferenceBoundary {
