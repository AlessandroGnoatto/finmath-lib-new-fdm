...
/**
 * Regression tests for 2D discretely monitored knock-out barrier options under
 * Heston and SABR.
 *
 * <p>
 * Structural property under test:
 * fewer monitoring dates imply a less likely knock-out, hence
 * </p>
 *
 * <pre>
 * coarse discrete >= fine discrete >= continuous
 * </pre>
 *
 * <p>
 * The tests cover European, Bermudan, and American exercise for:
 * </p>
 * <ul>
 *   <li>Heston down-and-out put</li>
 *   <li>SABR up-and-out call</li>
 * </ul>
 *
 * @author Alessandro Gnoatto
 */
public class BarrierOptionStochasticVolatilityDiscreteMonitoringKnockOutTest {
	...
	@Test
	public void testHestonDownOutPutDiscreteMonitoringOrderingEuropean() {
		assertDiscreteMonitoringOrderingForHestonDownOutPut(
				new EuropeanExercise(MATURITY)
		);
	}

	@Test
	public void testHestonDownOutPutDiscreteMonitoringOrderingBermudan() {
		assertDiscreteMonitoringOrderingForHestonDownOutPut(
	...
	@Test
	public void testHestonDownOutPutDiscreteMonitoringOrderingAmerican() {
		assertDiscreteMonitoringOrderingForHestonDownOutPut(
	...
	@Test
	public void testSabrUpOutCallDiscreteMonitoringOrderingEuropean() {
		assertDiscreteMonitoringOrderingForSabrUpOutCall(
				new EuropeanExercise(MATURITY)
		);
	}

	@Test
	public void testSabrUpOutCallDiscreteMonitoringOrderingBermudan() {
		assertDiscreteMonitoringOrderingForSabrUpOutCall(
				new BermudanExercise(new double[] { 0.25, 0.50, 0.75, 1.00 })
		);
	}
	...
	@Test
	public void testSabrUpOutCallDiscreteMonitoringOrderingAmerican() {
		assertDiscreteMonitoringOrderingForSabrUpOutCall(
				new AmericanExercise(MATURITY)
		);
	}

	private void assertDiscreteMonitoringOrderingForHestonDownOutPut(final Exercise exercise) {
	...
	private void assertDiscreteMonitoringOrderingForSabrUpOutCall(final Exercise exercise) {
