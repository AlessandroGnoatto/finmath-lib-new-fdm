...
public class BarrierOptionBachelierBermudanKnockInTest {
	...
	@Test
	public void testOneDateBermudanEqualsEuropeanDownAndInPut() {
		runOneDateBermudanEqualsEuropeanTest(CallOrPut.PUT, BarrierType.DOWN_IN, 80.0);
	}

	@Test
	public void testOneDateBermudanEqualsEuropeanUpAndInCall() {
		runOneDateBermudanEqualsEuropeanTest(CallOrPut.CALL, BarrierType.UP_IN, 120.0);
	}

	@Test
	public void testTwoDateBermudanGreaterOrEqualEuropeanDownAndInPut() {
		runOrderingTest(CallOrPut.PUT, BarrierType.DOWN_IN, 80.0);
	}

	@Test
	public void testTwoDateBermudanGreaterOrEqualEuropeanUpAndInCall() {
		runOrderingTest(CallOrPut.CALL, BarrierType.UP_IN, 120.0);
	}

	@Test
	public void testBermudanDownInPutLessOrEqualBermudanVanillaPut() {
		runKnockInLessOrEqualVanillaTest(CallOrPut.PUT, BarrierType.DOWN_IN, 80.0);
	}

	@Test
	public void testBermudanUpInCallLessOrEqualBermudanVanillaCall() {
		runKnockInLessOrEqualVanillaTest(CallOrPut.CALL, BarrierType.UP_IN, 120.0);
	}

	@Test
	public void testBermudanDownInCallLessOrEqualBermudanVanillaCall() {
		runKnockInLessOrEqualVanillaTest(CallOrPut.CALL, BarrierType.DOWN_IN, 80.0);
	}

	@Test
	public void testBermudanUpInPutLessOrEqualBermudanVanillaPut() {
		runKnockInLessOrEqualVanillaTest(CallOrPut.PUT, BarrierType.UP_IN, 120.0);
	}
	...
	private void runKnockInLessOrEqualVanillaTest(
			final CallOrPut callOrPut,
		...
		final double[] exerciseTimes = new double[] { 0.5, MATURITY };
		final BermudanExercise bermudanExercise = new BermudanExercise(exerciseTimes);
	...
	private TestSetup createVanillaSetup() {
		...
		final double standardDeviation = VOLATILITY * Math.sqrt(MATURITY);
		final double sMin = SPOT - 6.0 * standardDeviation;
		final double sMax = SPOT + 6.0 * standardDeviation;
