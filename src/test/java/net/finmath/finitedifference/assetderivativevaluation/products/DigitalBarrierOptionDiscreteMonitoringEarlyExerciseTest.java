...
/**
 * Regression tests for 1D discretely monitored digital barrier options
 * with Bermudan / American exercise.
 */
public class DigitalBarrierOptionDiscreteMonitoringEarlyExerciseTest {
	...
	@Test
	public void testBermudanDownInCashPutDiscreteMonitoringOrderingAndActivatedUpperBound() {
		...
		final double activatedValue = extractValueAtSpot(activated.getValue(0.0, model), model, SPOT);

		assertTrue(coarseValue >= -ORDERING_TOLERANCE);
		assertTrue(coarseValue <= fineValue + ORDERING_TOLERANCE);
		assertTrue(fineValue <= activatedValue + ORDERING_TOLERANCE);
	}

	@Test
	public void testAmericanUpInCashCallDiscreteMonitoringOrderingAndActivatedUpperBound() {
	...
	@Test
	public void testBermudanUpOutCashCallDiscreteMonitoringOrderingAndVanillaUpperBound() {
	...
	@Test
	public void testAmericanDownOutCashPutDiscreteMonitoringOrderingAndVanillaUpperBound() {
	...
	@Test
	public void testBermudanDownInEventConditionReplacesByActivatedContinuationValue() {
	...
	@Test
	public void testAmericanUpInEventConditionReplacesByActivatedContinuationValue() {
	...
	@Test
	public void testBermudanUpOutEventConditionZeroesBreachedNodes() {
	...
	@Test
	public void testAmericanDownOutEventConditionZeroesBreachedNodes() {
