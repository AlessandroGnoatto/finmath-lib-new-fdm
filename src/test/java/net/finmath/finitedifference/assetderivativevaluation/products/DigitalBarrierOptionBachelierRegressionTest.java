 ...
 */
public class DigitalBarrierOptionBachelierRegressionTest {
    ...
    private static final double DOMINANCE_TOLERANCE = 1E-6;
    ...
    private void runRegression(
        ...
        System.out.println("Bachelier regression");
    ...
    private TestSetup createVanillaSetup() {
        ...
        final double standardDeviationProxy = VOLATILITY * Math.sqrt(MATURITY);

        final double sMin =
                forward - NUMBER_OF_STANDARD_DEVIATIONS * standardDeviationProxy;
        final double sMax =
                forward + NUMBER_OF_STANDARD_DEVIATIONS * standardDeviationProxy;
