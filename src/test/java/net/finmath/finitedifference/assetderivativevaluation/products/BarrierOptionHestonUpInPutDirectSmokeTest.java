...
/**
 * Smoke test for direct 2D Heston up-in put pricing.
 */
public class BarrierOptionHestonUpInPutDirectSmokeTest {
	...
	public void testUpInEuropeanPutDirectHestonSmoke() throws Exception {
		...
		System.out.println("HESTON DIRECT UP-IN PUT SMOKE");
