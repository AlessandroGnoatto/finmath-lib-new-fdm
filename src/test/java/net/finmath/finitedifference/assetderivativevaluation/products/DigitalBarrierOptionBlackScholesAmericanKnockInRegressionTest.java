...
/**
 * Regression tests for American knock-in DigitalBarrierOption under Black-Scholes.
 *
 * <p>Checks:
 * <ul>
 *   <li>American >= Bermudan >= European,</li>
 *   <li>American knock-in <= corresponding American vanilla digital,</li>
 *   <li>Bermudan knock-in <= corresponding Bermudan vanilla digital,</li>
 *   <li>European knock-in <= corresponding European vanilla digital.</li>
 * </ul>
 *
 * @author Alessandro Gnoatto
 */
public class DigitalBarrierOptionBlackScholesAmericanKnockInRegressionTest {
    ...
    @Test
    public void testDownInCashCallAmericanRegression() {
        runRegressionTest(
                CallOrPut.CALL,
                BarrierType.DOWN_IN,
    ...
    @Test
    public void testDownInCashPutAmericanRegression() {
        runRegressionTest(
                CallOrPut.PUT,
                BarrierType.DOWN_IN,
                DigitalPayoffType.CASH_OR_NOTHING,
    ...
    @Test
    public void testDownInAssetCallAmericanRegression() {
        runRegressionTest(
                CallOrPut.CALL,
                BarrierType.DOWN_IN,
    ...
    @Test
    public void testDownInAssetPutAmericanRegression() {
        runRegressionTest(
                CallOrPut.PUT,
                BarrierType.DOWN_IN,
                DigitalPayoffType.ASSET_OR_NOTHING,
    ...
    @Test
    public void testUpInCashCallAmericanRegression() {
        runRegressionTest(
                CallOrPut.CALL,
                BarrierType.UP_IN,
                DigitalPayoffType.CASH_OR_NOTHING,
    ...
    @Test
    public void testUpInCashPutAmericanRegression() {
        runRegressionTest(
                CallOrPut.PUT,
                BarrierType.UP_IN,
                DigitalPayoffType.CASH_OR_NOTHING,
    ...
    @Test
    public void testUpInAssetCallAmericanRegression() {
        runRegressionTest(
                CallOrPut.CALL,
                BarrierType.UP_IN,
                DigitalPayoffType.ASSET_OR_NOTHING,
    ...
    @Test
    public void testUpInAssetPutAmericanRegression() {
        runRegressionTest(
                CallOrPut.PUT,
                BarrierType.UP_IN,
                DigitalPayoffType.ASSET_OR_NOTHING,
    ...
    private void runRegressionTest(
        ...
        final DigitalBarrierOption europeanKnockIn = new DigitalBarrierOption(
                null,
                MATURITY,
                STRIKE,
                barrier,
        ...
        final DigitalBarrierOption bermudanKnockIn = new DigitalBarrierOption(
                null,
                MATURITY,
                STRIKE,
                barrier,
        ...
        final DigitalBarrierOption americanKnockIn = new DigitalBarrierOption(
                null,
                MATURITY,
                STRIKE,
                barrier,
        ...
        final double europeanKnockInValue = extractValueAtSpot(
                europeanKnockIn.getValue(0.0, model),
                sNodes,
                S0
        );

        final double bermudanKnockInValue = extractValueAtSpot(
                bermudanKnockIn.getValue(0.0, model),
                sNodes,
                S0
        );

        final double americanKnockInValue = extractValueAtSpot(
                americanKnockIn.getValue(0.0, model),
                sNodes,
                S0
        );
        ...
        System.out.println("American knock-in regression test");
        ...
        System.out.println("European knock-in    = " + europeanKnockInValue);
        System.out.println("Bermudan knock-in    = " + bermudanKnockInValue);
        System.out.println("American knock-in    = " + americanKnockInValue);
        ...
        System.out.println("B - E                = " + (bermudanKnockInValue - europeanKnockInValue));
        System.out.println("A - B                = " + (americanKnockInValue - bermudanKnockInValue));
        System.out.println("A barrier - A van    = " + (americanKnockInValue - americanVanillaValue));

        assertTrue(europeanKnockInValue >= -1E-10);
        assertTrue(bermudanKnockInValue >= -1E-10);
        assertTrue(americanKnockInValue >= -1E-10);
        ...
        assertTrue(
                "Bermudan knock-in should be >= European knock-in for "
                        + barrierType + " " + callOrPut + " " + digitalPayoffType,
                bermudanKnockInValue + ORDERING_TOL >= europeanKnockInValue
        );

        assertTrue(
                "American knock-in should be >= Bermudan knock-in for "
                        + barrierType + " " + callOrPut + " " + digitalPayoffType,
                americanKnockInValue + ORDERING_TOL >= bermudanKnockInValue
        );

        assertTrue(
                "European knock-in should be <= corresponding European vanilla digital for "
                        + barrierType + " " + callOrPut + " " + digitalPayoffType,
                europeanKnockInValue <= europeanVanillaValue + VANILLA_COMPARISON_TOL
        );

        assertTrue(
                "Bermudan knock-in should be <= corresponding Bermudan vanilla digital for "
                        + barrierType + " " + callOrPut + " " + digitalPayoffType,
                bermudanKnockInValue <= bermudanVanillaValue + VANILLA_COMPARISON_TOL
        );

        assertTrue(
                "American knock-in should be <= corresponding American vanilla digital for "
                        + barrierType + " " + callOrPut + " " + digitalPayoffType,
                americanKnockInValue <= americanVanillaValue + VANILLA_COMPARISON_TOL
        );
    }
