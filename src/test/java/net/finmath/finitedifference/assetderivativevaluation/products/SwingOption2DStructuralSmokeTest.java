...
/**
 * Fast structural smoke tests for the 2D fixed-strike SwingOption recursion.
 *
 * <p>
 * Focus:
 * </p>
 ...
 *   <li>the contract value is non-negative.</li>
 * </ul>
 *
 * <p>
 ...
 * </p>
 */
public class SwingOption2DStructuralSmokeTest {
	...
	private static final double NON_NEGATIVE_TOL = 1E-10;
	...
	@Test
	public void testHestonValueIsNonNegative() {
		runNonNegativeValueTest(ModelType.HESTON);
	}

	@Test
	public void testSabrValueIsNonNegative() {
		runNonNegativeValueTest(ModelType.SABR);
	}
	...
	private void runNonNegativeValueTest(final ModelType modelType) {
		final TwoDimensionalSetup setup = createTwoDimensionalSetup(modelType, SPOT);
		...
		assertTrue(value >= -NON_NEGATIVE_TOL);
	}
