 ...
 */
public class BarrierOptionDiscreteMonitoringEarlyExerciseKnockInTest {
	...
	private static final double ORDERING_TOLERANCE = 1E-6;
	private static final double EVENT_TOLERANCE = 1E-10;
	private static final double BARRIER_TOLERANCE = 1E-12;

	@Test
	public void testBermudanDownInPutDiscreteMonitoringOrderingAndActivatedUpperBound() {
		...
		final double activatedValue = extractValueAtSpot(activated.getValue(0.0, model), model, S0);
	...
	@Test
	public void testAmericanUpInCallDiscreteMonitoringOrderingAndActivatedUpperBound() {
