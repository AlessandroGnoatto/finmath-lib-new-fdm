...
/**
 * Focused debug test for the direct 2D Heston up-in put case.
 */
public class BarrierOptionHestonUpInPutDirectDebugTest {

	private static final double MATURITY = 1.0;
	private static final double STRIKE = 100.0;
	private static final double BARRIER = 120.0;
	...
	@Test
	public void testUpInEuropeanPutDirectHestonDebug() throws Exception {
		...
		System.out.println("HESTON DIRECT UP-IN PUT DEBUG");
