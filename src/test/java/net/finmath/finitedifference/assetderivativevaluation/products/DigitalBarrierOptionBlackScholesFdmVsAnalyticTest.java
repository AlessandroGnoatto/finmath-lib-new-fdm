 ...
 * European single-barrier digital options.
 *
 * <p>
 * Covered products:
 * </p>
 ...
 * </p>
 * <ul>
 *   <li>knock-out options use a barrier-on-boundary grid,</li>
 ...
 */
public class DigitalBarrierOptionBlackScholesFdmVsAnalyticTest {
    ...
    /**
     * Extra lower-tail depth for DOWN_IN PUT-like configurations.
     */
    private static final int DOWN_IN_PUT_EXTRA_STEPS = 160;

    /**
     * Extra upper-tail depth for UP_IN CALL-like configurations.
     */
    private static final int UP_IN_CALL_EXTRA_STEPS = 160;

    @Test
    public void testDownAndOutCashDigitalCallBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.CALL, BarrierType.DOWN_OUT, DigitalPayoffType.CASH_OR_NOTHING, 80.0, 0.40);
    }

    @Test
    public void testDownAndInCashDigitalCallBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.CALL, BarrierType.DOWN_IN, DigitalPayoffType.CASH_OR_NOTHING, 80.0, 0.40);
    }

    @Test
    public void testUpAndOutCashDigitalCallBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.CALL, BarrierType.UP_OUT, DigitalPayoffType.CASH_OR_NOTHING, 120.0, 0.40);
    }

    @Test
    public void testUpAndInCashDigitalCallBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.CALL, BarrierType.UP_IN, DigitalPayoffType.CASH_OR_NOTHING, 120.0, 0.40);
    }

    @Test
    public void testDownAndOutCashDigitalPutBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.PUT, BarrierType.DOWN_OUT, DigitalPayoffType.CASH_OR_NOTHING, 80.0, 0.40);
    }

    @Test
    public void testDownAndInCashDigitalPutBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.PUT, BarrierType.DOWN_IN, DigitalPayoffType.CASH_OR_NOTHING, 80.0, 0.40);
    }

    @Test
    public void testUpAndOutCashDigitalPutBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.PUT, BarrierType.UP_OUT, DigitalPayoffType.CASH_OR_NOTHING, 120.0, 0.40);
    }

    @Test
    public void testUpAndInCashDigitalPutBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.PUT, BarrierType.UP_IN, DigitalPayoffType.CASH_OR_NOTHING, 120.0, 0.40);
    }

    @Test
    public void testDownAndOutAssetDigitalCallBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.CALL, BarrierType.DOWN_OUT, DigitalPayoffType.ASSET_OR_NOTHING, 80.0, 0.55);
    }

    @Test
    public void testDownAndInAssetDigitalCallBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.CALL, BarrierType.DOWN_IN, DigitalPayoffType.ASSET_OR_NOTHING, 80.0, 0.55);
    }

    @Test
    public void testUpAndOutAssetDigitalCallBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.CALL, BarrierType.UP_OUT, DigitalPayoffType.ASSET_OR_NOTHING, 120.0, 0.55);
    }

    @Test
    public void testUpAndInAssetDigitalCallBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.CALL, BarrierType.UP_IN, DigitalPayoffType.ASSET_OR_NOTHING, 120.0, 0.55);
    }

    @Test
    public void testDownAndOutAssetDigitalPutBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.PUT, BarrierType.DOWN_OUT, DigitalPayoffType.ASSET_OR_NOTHING, 80.0, 0.55);
    }

    @Test
    public void testDownAndInAssetDigitalPutBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.PUT, BarrierType.DOWN_IN, DigitalPayoffType.ASSET_OR_NOTHING, 80.0, 0.55);
    }

    @Test
    public void testUpAndOutAssetDigitalPutBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.PUT, BarrierType.UP_OUT, DigitalPayoffType.ASSET_OR_NOTHING, 120.0, 0.55);
    }

    @Test
    public void testUpAndInAssetDigitalPutBlackScholesFiniteDifferenceVsAnalytic() {
        runDigitalBarrierTest(CallOrPut.PUT, BarrierType.UP_IN, DigitalPayoffType.ASSET_OR_NOTHING, 120.0, 0.55);
    }

    private void runDigitalBarrierTest(
        ...
        final DigitalBarrierOption fdmProduct = new DigitalBarrierOption(
                MATURITY,
                STRIKE,
                barrier,
                callOrPut,
        ...
        final double analyticPrice = BarrierOptions.blackScholesBinaryBarrierOptionValue(
                S0,
                R,
                Q,
                SIGMA,
                ...
                mapDigitalPayoffType(digitalPayoffType),
                CASH_PAYOFF
        );
        ...
        assertEquals(
                "FD vs analytic digital barrier price for " + barrierType + " " + callOrPut + " " + digitalPayoffType,
                analyticPrice,
                fdPrice,
                tolerance
        );
    ...
    private static BarrierOptions.BinaryPayoffType mapDigitalPayoffType(final DigitalPayoffType digitalPayoffType) {
        switch(digitalPayoffType) {
        case CASH_OR_NOTHING:
            return BarrierOptions.BinaryPayoffType.CASH_OR_NOTHING;
        case ASSET_OR_NOTHING:
            return BarrierOptions.BinaryPayoffType.ASSET_OR_NOTHING;
        default:
            throw new IllegalArgumentException("Unsupported digital payoff type: " + digitalPayoffType);
        }
    }
