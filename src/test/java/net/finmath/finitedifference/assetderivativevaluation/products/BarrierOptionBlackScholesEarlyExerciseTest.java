...
public class BarrierOptionBlackScholesEarlyExerciseTest {
	...
	private void runBarrierLessOrEqualVanillaTest(
		...
		if(americanExercise.isAmerican()) {
			final AmericanOption vanilla = new AmericanOption(MATURITY, STRIKE, callOrPut);
			vanillaPrice = interpolateAtSpot(vanilla.getValue(0.0, setup.model), setup.sNodes, SPOT);
		}
		else {
