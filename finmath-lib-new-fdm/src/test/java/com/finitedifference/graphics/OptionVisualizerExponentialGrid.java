...
public class OptionVisualizerExponentialGrid {
	...
	public static void main(String[] args) {
		...
		final Grid spaceGrid = new ExponentialGrid(numSpacesteps, minimumStockPrice, maximumStockPrice, 0.9);

		TimeDiscretization uniformTimeDiscretization = new TimeDiscretizationFromArray(0.0,numTimesteps,1.0/numTimesteps);
		
		SpaceTimeDiscretization spaceTimeDiscretizationExponential = new SpaceTimeDiscretization(spaceGrid, uniformTimeDiscretization, theta, new double[] {initialValue});
		
		final FiniteDifferenceEquityModel model = new FDMBlackScholesModel(
				initialValue, riskFreeRate, volatility,
				spaceTimeDiscretizationExponential);
		...
		final double[] xCall = spaceGrid.getInteriorGrid();//[0]; //initialStockPriceForCall
		...
		JFreeChart chartCallValore = ChartFactory.createXYLineChart(
				"Call Option Exponential Grid: FDM vs Analitica",
				"Prezzo Iniziale",
				"Valore Opzione",
				datasetCallValore,
		...
		JFreeChart chartCallErrore = ChartFactory.createXYLineChart(
				"Errore Assoluto Call Exponential Grid",
				"Prezzo Iniziale",
				"Errore",
				datasetCallErrore,
				PlotOrientation.VERTICAL,
		...
		JFreeChart chartPutValore = ChartFactory.createXYLineChart(
				"Put Option Exponential Grid: FDM vs Analitica",
				"Prezzo Iniziale",
				"Valore Opzione",
				datasetPutValore,
				PlotOrientation.VERTICAL,
		...
		JFreeChart chartPutErrore = ChartFactory.createXYLineChart(
				"Errore Assoluto Put Exponential Grid",
				"Prezzo Iniziale",
				"Errore",
				datasetPutErrore,
				PlotOrientation.VERTICAL,
		...
		JFrame frame = new JFrame("Option Visualizer Exponential Grid: Call & Put con errori");
		...
		JFrame frameCall = new JFrame("Call Option Exponential Grid: Valore + Errore");
		...
		JFrame framePut = new JFrame("Put Option Exponential Grid: Valore + Errore");
