...
public class OptionVisualizerHyperbolicSineGrid {
    ...
    public static void main(String[] args) {
        ...
        final Grid spaceGrid = new HyperbolicSineGrid(numSpacesteps, minimumStockPrice, maximumStockPrice, 50.0, 0.1);

        TimeDiscretization uniformTimeDiscretization = new TimeDiscretizationFromArray(0.0,numTimesteps,1.0/numTimesteps);
		
		SpaceTimeDiscretization spaceTimeDiscretizationHyperbolicSine = new SpaceTimeDiscretization(spaceGrid, uniformTimeDiscretization, theta, new double[] {initialValue});
		
        final FiniteDifferenceEquityModel model = new FDMBlackScholesModel(
        		initialValue, riskFreeRate, volatility,
        		spaceTimeDiscretizationHyperbolicSine);
        ...
        JFreeChart chartCallValore = ChartFactory.createXYLineChart(
                "Call Option Hyperbolic Sine Grid: FDM vs Analitica",
                "Prezzo Iniziale",
                "Valore Opzione",
                datasetCallValore,
        ...
        JFreeChart chartCallErrore = ChartFactory.createXYLineChart(
                "Errore Assoluto Call Hyperbolic Sine Grid",
                "Prezzo Iniziale",
                "Errore",
                datasetCallErrore,
                PlotOrientation.VERTICAL,
        ...
        JFreeChart chartPutValore = ChartFactory.createXYLineChart(
                "Put Option Hyperbolic Sine Grid: FDM vs Analitica",
                "Prezzo Iniziale",
                "Valore Opzione",
                datasetPutValore,
                PlotOrientation.VERTICAL,
        ...
        JFreeChart chartPutErrore = ChartFactory.createXYLineChart(
                "Errore Assoluto Put Hyperbolic Sine Grid",
                "Prezzo Iniziale",
                "Errore",
                datasetPutErrore,
                PlotOrientation.VERTICAL,
        ...
        JFrame frame = new JFrame("Option Visualizer Hyperbolic Sine Grid: Call & Put con errori");
        ...
        JFrame frameCall = new JFrame("Call Option Hyperbolic Sine Grid: Valore + Errore");
        ...
        JFrame framePut = new JFrame("Put Option Hyperbolic Sine Grid: Valore + Errore");
        ...
        framePut.pack();
        framePut.setLocation(700, 100); // sposta un po' la finestra
