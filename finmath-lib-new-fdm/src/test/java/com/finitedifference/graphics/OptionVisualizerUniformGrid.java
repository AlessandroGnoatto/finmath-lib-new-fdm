...
public class OptionVisualizerUniformGrid {
    ...
    public static void main(String[] args) {
        ...
        JFreeChart chartCallValore = ChartFactory.createXYLineChart(
                "Call Option Uniform Gird: FDM vs Analitica",
                "Prezzo Iniziale",
                "Valore Opzione",
                datasetCallValore,
        ...
        JFreeChart chartCallErrore = ChartFactory.createXYLineChart(
                "Errore Assoluto Call Uniform Gird",
                "Prezzo Iniziale",
                "Errore",
                datasetCallErrore,
                PlotOrientation.VERTICAL,
        ...
        JFreeChart chartPutValore = ChartFactory.createXYLineChart(
                "Put Option Uniform Gird: FDM vs Analitica",
                "Prezzo Iniziale",
                "Valore Opzione",
                datasetPutValore,
                PlotOrientation.VERTICAL,
        ...
        JFreeChart chartPutErrore = ChartFactory.createXYLineChart(
                "Errore Assoluto Put Uniform Gird",
                "Prezzo Iniziale",
                "Errore",
                datasetPutErrore,
                PlotOrientation.VERTICAL,
        ...
        JFrame frame = new JFrame("Option Visualizer Uniform Gird: Call & Put con errori");
        ...
        JFrame frameCall = new JFrame("Call Option Uniform Gird: Valore + Errore");
        ...
        JFrame framePut = new JFrame("Put Option Uniform Gird: Valore + Errore");
