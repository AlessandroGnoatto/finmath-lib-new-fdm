...
public class ThetaTestHyperbolicSine {
	...
	public void testEuropeanCallOption() throws AssertionError {
		...
		System.out.print("Anlytical values:");
		...
		for (int i = 0; i < analyticalCallOptionValue.length; i++) {
			...
			System.out.print(analyticalCallOptionValue[i] + ", ");
		}
		System.out.println();
		System.out.print("Call values:");
		System.out.println(Arrays.toString(callOptionValue));
		Assert.assertArrayEquals(callOptionValue, analyticalCallOptionValue, 1e-1);
	}
	...
	public void testEuropeanPutOption() throws AssertionError { 
		...
		Assert.assertArrayEquals(putOptionValue, analyticalPutOptionValue, 1e-1); 
	} 
}
